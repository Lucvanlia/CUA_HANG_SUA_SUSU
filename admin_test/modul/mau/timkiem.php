<?php
        ...
        if(isset($_POST['tim']))
        {
             $sql_timkiem = "SELECT * FROM chatlieu WHERE chatlieu.TenChatLieu like '%".$search."%'";
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input name="chkmh[]" type="checkbox" value="<?php echo $row['id_chatlieu']; ?>"></td>
                                        </tr>
                                        <?php	
                                                }//kt while 
                                                ?>
                                                                <div class="form-group"><a class="btn btn-danger" href="index.php?action=quanlychatlieu&query=them">Trở lại</a></div>
                                    </tbody>
                                </table>
                                </form>
                            </div>
