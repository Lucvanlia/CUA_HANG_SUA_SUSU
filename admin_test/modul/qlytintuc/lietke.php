...
<div class=" mb-4" id="DesignationTable" style="background-color:#fff">
                        <div class="card-header py-3" style="background-color:#fff">
                            <h3 class="m-0 font-weight-bold text-primary">Danh Sách Tin Tức</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="py-4 d-flex flex-row bd-highlight mb-3">
                                ...
                                <input type="text" id="search_chatlieu"name ="search"class="col-form-label"  placeholder="Tìm Tin Tức" autocomplete="off" value="<?php if(isset($_GET["search"])) {echo $_GET["search"];}?>">
                            ...
                            <form action="modul/qlytintuc/xly.php" method="post">
                           <div class="row" >
                           <div class="col-md-3 py-3 d-flex flex-row bd-highlight-reverse mb-3">
                            ...
                            <td>Số lượng Tin Tức: <?php echo $count?></td>  
                                ...
                                <thead>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="?action=quanlytintuc&query=sua&id=<?php echo $row['id_TinTuc'];?>" ><i class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td class="<?php $stt?>"><input name="ckcl[]" type="checkbox"  value="<?php echo $row['id_TinTuc'];  ?> "class="Organization_Desg_Check_margin" id="OrganizationDesgCheckData1<?php echo $stt?>"></td>
                                        </tr>
                                        <?php	
                                                }//kt while 
                                                ?>
