...
<div class=" mb-4" id="DesignationTable" style="background-color:#fff">
                        ...
                        <div class="card-body">
                            ...
                            <div class="py-4 d-flex flex-row bd-highlight mb-3">
                                ...
                                <input type="text" id="search_loai" name ="search"class="col-form-label"  placeholder="Tìm loại giày" autocomplete="off" value="<?php if(isset($_GET["search"])) {echo $_GET["search"];}?>">
                           ...
                           <div class="col-md-3 py-3 d-flex flex-row bd-highlight-reverse mb-3">
                            ...
                            <td>Số lượng loại giày: <?php echo $count?></td>  
                                ...
                                <thead>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="<?php $stt?>"><input name="ckcl[]" type="checkbox"  value="<?php echo $row['id_loai'];  ?> "class="Organization_Desg_Check_margin" id="OrganizationDesgCheckData1<?php echo $stt?>"></td>
                                        </tr>
                                        <?php	
                                                }//kt while 
                                                ?>
