...
<div class=" mb-4" id="DesignationTable" style="background-color:#fff">
                        ...
                        <div class="card-body">
                            ...
                            <div class="py-4 d-flex flex-row bd-highlight mb-3">
                                ...
                                <form method="post" action="index.php?action=timkiem&query=timkiem_diadiem" class="py-2">
                                <label for="">Tìm kiếm sản phẩm</label>
                                <input type="text" id="search_diadiem" name ="search"class="col-form-label"  placeholder="Tìm địa điểm" autocomplete="off" value="<?php if(isset($_GET["search"])) {echo $_GET["search"];}?>">
                            ...
                            <form action="modul/qlydiadiem/xly.php" method="post">
                           <div class="row" >
                           <div class="col-md-3 py-3 d-flex flex-row bd-highlight-reverse mb-3">
                            ...
                            <td>Số lượng địa điểm: <?php echo $count?></td>  
                                ...
                                <thead>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="?action=quanlydiadiem&query=sua&id=<?php echo $row['id_diadiem'];?>" ><i class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td class="<?php $stt?>"><input name="ckcl[]" type="checkbox"  value="<?php echo $row['id_diadiem'];  ?> "class="Organization_Desg_Check_margin" id="OrganizationDesgCheckData1<?php echo $stt?>"></td>
                                        </tr>
                                        <?php	
                                                }//kt while 
                                                ?>
