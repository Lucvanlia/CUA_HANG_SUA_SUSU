        ...
        <div class="form-container  " >
            <form method="post" action="modul/qlysanpham/xly.php" enctype="multipart/form-data">
              ...
              <div class="form-group  py-3    ">
                ...
                <div class="form-group  py-3    ">
                  <label for="" class="form-label  "><strong>Chọn xuất xứ:</strong></label>
                 <select name="cmbdd" class="dtform   form-select form-select-lg mb-3 "  >
                   <?php
                      while($rows = mysqli_fetch_array($result_diadiem))
                      {
                    ?>
                      <option value="<?=$rows['id_diadiem']?>"  required> <?=$rows['tendiadiem']?></option>
                      <?php
                        $i = $i + 1;
                      }//KT Else
                    ?>
                ...
                <div class="form-group mx-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="txtmota"row="10" col="25" required></textarea>
