                    ...
                    <div class="col-xl-2 col-12 block-title-cate">
                        <div class="block-title">
                            ...
                            <ul class="list-unstyled block-cate">
                                ...
                                ?>
                                    <li>
                                        <a href="category.php?id=<?= $id_dm_con ?>" title="<?= $ten_dm_con ?>"><?= $ten_dm_con ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnAddToCart">Thêm giỏ hàng</button>
            </div>
        </div>
    </div>
</div>
